...
CREATE              procedure [dbo].[CHCNWEB_GetCHC_AAEligCombo]
...
--9/28/2009, CTA, start using membssn field instead of subbssn
-- ADDED AC FIELD, 09/01/2011, CTA
	
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CHC_AAELIG]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE [dbo].[CHC_AAELIG]

CREATE TABLE [dbo].CHC_AAELIG (CHC char(10), COMPANY varchar(40), EFFDATE varchar(10), TERMDATE varchar(10), PATID varchar(15),
