CREATE TABLE [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL]
(
...
[MEDICAL_GROUP] [varchar] (45) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CONTRACT] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [AUTHSPEC_CITY] ON [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL] ([CITY]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [AUTHSPEC_CODE] ON [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL] ([CODE]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [AUTHSPEC_ID] ON [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL] ([ID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [AUTHSPEC_LN] ON [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL] ([LASTNAME]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [AUTHSPEC_PROVID] ON [dbo].[CHCNPORTAL_AUTHSPECIALISTS_ALL] ([PROVID]) ON [PRIMARY]
GO
